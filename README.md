...
- Observable runs that can be [paused, resumed, and retried](https://markosski.github.io/relayfold/docs/concepts/workflow-lifecycle/)
- [Human input](https://markosski.github.io/relayfold/docs/concepts/human-input/) and [bounded verifier loops](https://markosski.github.io/relayfold/docs/concepts/bounded-loops/) for agentic workflows
- Controlled access to [credentials](https://markosski.github.io/relayfold/docs/operations/credentials/) and [workspaces](https://markosski.github.io/relayfold/docs/operations/workspaces/)
- Independently scalable [orchestrators and workers](https://markosski.github.io/relayfold/docs/operations/scaling/)
...
- [Use the API reference](https://markosski.github.io/relayfold/docs/api-reference/)
- [Understand the architecture](https://markosski.github.io/relayfold/docs/concepts/architecture/)
