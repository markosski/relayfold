...
- [x] 2.9 Release or expire dispatch leases on task completion, worker disconnect, timeout, and late result paths
- [x] 2.10 Add worker pool tests for heartbeat registration, heartbeat deregistration, heartbeat rejoin, matching host claims, mismatched host rejection, multiple workers sharing a host, and single active task per workflow instance
