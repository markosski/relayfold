...
See [Tasks](/relayfold/docs/concepts/tasks/) for how Agent, Function, and API Call tasks differ.
...
When a task enters `InputNeeded`, the workflow pauses for human input. See [Human Input](/relayfold/docs/concepts/human-input/) for the operator flow and API request.

See [Workflow Lifecycle](/relayfold/docs/concepts/workflow-lifecycle/) for pause, resume, retry, events, and queue behavior.
